...
{return;}});}});})(jQuery,this);(function($,window,undefined){if(EA.mobile&&EA.mobile.agents){for(i in EA.mobile.agents){var regex=new RegExp(EA.mobile.agents[i],"i");if(navigator.userAgent.match(regex)){$('#mod-mobile-redirect').show();break;}}}})(jQuery,this);(function($){var actualLocale=$('body').attr('class').substring(0,2);switch(actualLocale){default:fbUrl='http://www.facebook.com/shankgame';twUrl='http://www.twitter.com/klei';followCopy='Follow Us';shareThisCopy='Share This';}
$('.row-2 .col-1').append('<div id="custom-social"><div class="menu"><div class="mod-content"><span>'+followCopy+':</span><a href="'+twUrl+'"><img src="'+EA.staticPath+EA.skinPath+'img/Nav_twitter.png?ver='+EA.staticVersion+'" /></a> <a href="'+fbUrl+'"><img src="'+EA.staticPath+EA.skinPath+'img/Nav_facebook.png?ver='+EA.staticVersion+'" /></a></div></div></div>');var logos='<div id="logos" class="row"><a href="http://www.ea.com"><img src="'+EA.staticPath+EA.skinPath+'img/logo_ea.png?ver='+EA.staticVersion+'"/></a><a href="http://www.kleientertainment.com"><img src="'+EA.staticPath+EA.skinPath+'img/logo_klei.png?ver='+EA.staticVersion+'"/></a></div>';$('#mod-footer').prepend(logos);$('#mod-footer .links:last').addClass('last');$('body').append('<div id="footer-border"></div>');if($('body#game-media').length>0||$('body#game-images').length>0||$('body#game-videos').length>0||$('body#game-image-detail').length>0||$('body#game-video-detail').length>0){$('.row-5').before('<div id="row5-media-header"></div>');$('.row-5').after('<div id="row5-media-footer"></div>');}
if($('body#game-image-detail').length>0||$('body#game-video-detail').length>0){$('#mod-social-networks .mod-content').append($('#mod-media-info .tags'));}})(jQuery);var actualLocale=$('body').attr('class').substring(0,2);var dictionary={ageGate:{instructions:{us:'Enter your date of birth (MM/DD/YYYY):',es:'Enter your date of birth (MM/DD/YYYY):',de:'Enter your date of birth (MM/DD/YYYY):',fr:'Enter your date of birth (MM/DD/YYYY):',it:'Enter your date of birth (MM/DD/YYYY):',nl:'Enter your date of birth (MM/DD/YYYY):',pl:'Enter your date of birth (MM/DD/YYYY):',ru:'Enter your date of birth (MM/DD/YYYY):',cz:'Enter your date of birth (MM/DD/YYYY):',jp:'Enter your date of birth (MM/DD/YYYY):'},monthLabel:{us:'MM',es:'MM',de:'MM',fr:'MM',it:'MM',nl:'MM',pl:'MM',ru:'MM',cz:'MM',jp:'MM'},dayLabel:{us:'DD',es:'DD',de:'DD',fr:'DD',it:'DD',nl:'DD',pl:'DD',ru:'DD',cz:'DD',jp:'DD'},yearLabel:{us:'YYYY',es:'YYYY',de:'YYYY',fr:'YYYY',it:'YYYY',nl:'YYYY',pl:'YYYY',ru:'YYYY',cz:'YYYY',jp:'YYYY'},buttonText:{us:'Continue',es:'Continue',de:'Continue',fr:'Continue',it:'Continue',nl:'Continue',pl:'Continue',ru:'Continue',cz:'Continue',jp:'Continue'},allowedAge:{us:17,es:17,de:17,fr:17,it:17,nl:17,pl:17,ru:17,cz:17,jp:17},underAgeMessage:{us:'Sorry, but you do not meet the criteria to view this content.',es:'Sorry, but you do not meet the criteria to view this content.',de:'Sorry, but you do not meet the criteria to view this content.',fr:'Sorry, but you do not meet the criteria to view this content.',it:'Sorry, but you do not meet the criteria to view this content.',nl:'Sorry, but you do not meet the criteria to view this content.',pl:'Sorry, but you do not meet the criteria to view this content.',ru:'Sorry, but you do not meet the criteria to view this content.',cz:'Sorry, but you do not meet the criteria to view this content.',jp:'Sorry, but you do not meet the criteria to view this content.'},errorMonthOutOfBounds:{us:'Your birth month must be a number between 1 and 12',es:'Your birth month must be a number between 1 and 12',de:'Your birth month must be a number between 1 and 12',fr:'Your birth month must be a number between 1 and 12',it:'Your birth month must be a number between 1 and 12',nl:'Your birth month must be a number between 1 and 12',pl:'Your birth month must be a number between 1 and 12',ru:'Your birth month must be a number between 1 and 12',cz:'Your birth month must be a number between 1 and 12',jp:'Your birth month must be a number between 1 and 12'},errorDayOutOfBounds:{us:'Your birth day must be a number between 1 and 31',es:'Your birth day must be a number between 1 and 31',de:'Your birth day must be a number between 1 and 31',fr:'Your birth day must be a number between 1 and 31',it:'Your birth day must be a number between 1 and 31',nl:'Your birth day must be a number between 1 and 31',pl:'Your birth day must be a number between 1 and 31',ru:'Your birth day must be a number between 1 and 31',cz:'Your birth day must be a number between 1 and 31',jp:'Your birth day must be a number between 1 and 31'},errorDayOutOfBoundsForMonth:{us:'Your birth day is greater than the total amount of days for that month',es:'Your birth day is greater than the total amount of days for that month',de:'Your birth day is greater than the total amount of days for that month',fr:'Your birth day is greater than the total amount of days for that month',it:'Your birth day is greater than the total amount of days for that month',nl:'Your birth day is greater than the total amount of days for that month',pl:'Your birth day is greater than the total amount of days for that month',ru:'Your birth day is greater than the total amount of days for that month',cz:'Your birth day is greater than the total amount of days for that month',jp:'Your birth day is greater than the total amount of days for that month'},errorYearOutOfBounds:{us:'Your birth year must be a four digit number',es:'Your birth year must be a four digit number',de:'Your birth year must be a four digit number',fr:'Your birth year must be a four digit number',it:'Your birth year must be a four digit number',nl:'Your birth year must be a four digit number',pl:'Your birth year must be a four digit number',ru:'Your birth year must be a four digit number',cz:'Your birth year must be a four digit number',jp:'Your birth year must be a four digit number'}}}
...
function addAgeGates($parentElement){$parentElement=$parentElement||$('#mod-custom');var $videoContainers=$('object',$parentElement).add($('iframe[src*="youtube.com/embed"]',$parentElement)).parent();$videoContainers.each(function(){$this=$(this);if($this.hasClass('restricted')){$this.wrapInner('<div class="video-wrap">');$video=$('.video-wrap',$this);var html='';html='<div class="age-gate">';html+=' <span class="age-gate-instructions">'+dictionary.ageGate.instructions[actualLocale]+'</span><br><br>';html+=' <form class="age-gate-form" name="ageGateForm" method="post" action="">';html+='  <div class="age-gate-selector">';html+='   <div class="agegate-selector shadow-2">';html+='    <input type="text" id="age_month" class="age-field age_month" autocomplete="off" maxlength="2" value="'+dictionary.ageGate.monthLabel[actualLocale]+'">';html+='   </div>';html+='   <div class="agegate-selector-b shadow-2">';html+='    <input type="text" id="age_day" class="age-field age_day" autocomplete="off" maxlength="2" value="'+dictionary.ageGate.dayLabel[actualLocale]+'">';html+='   </div>';html+='   <div class="agegate-selector shadow-2">';html+='    <input type="text" id="age_year" class="age-field age_year" autocomplete="off" maxlength="4" value="'+dictionary.ageGate.yearLabel[actualLocale]+'">';html+='   </div>';html+='   <a class="verify" href="#"><span>'+dictionary.ageGate.buttonText[actualLocale]+'</span></a>';html+='  </div>';html+=' </form>';html+='</div>';$this.prepend(html);$ageGate=$('.age-gate',$this);$ageGateInstructions=$('.age-gate-instructions',$this);$ageGateForm=$('.age-gate-form',$this);$videoObject=$('.video-wrap :first-child',$this);$ageGate.css({height:$this.height(),width:$videoObject.width()});var ageGateAccess=getCookie('ofAge');if(ageGateAccess=='1'){$ageGate.hide();}
else if(ageGateAccess=='0'){$video.hide();$ageGate.show();$ageGateInstructions.html(dictionary.ageGate.underAgeMessage[actualLocale]);$ageGateForm.show();}
else{$video.hide();$ageGate.show();$ageGateForm.show();}
$(".verify",$this).click(function(e){verifyAge($(e.target).parents('.restricted'),dictionary.ageGate.allowedAge[actualLocale]);e.preventDefault();});}});}
function verifyAge($container,minAge){var DOB_month=$(".age_month",$container).val();var DOB_day=$(".age_day",$container).val();var DOB_year=$(".age_year",$container).val();var month=Number(DOB_month);var day=Number(DOB_day);var year=Number(DOB_year);if(DOB_month.search(/^\d{1,2}$/)==-1||month<1||month>12){alert(dictionary.ageGate.errorMonthOutOfBounds[actualLocale]);return false;}
else if(DOB_day.search(/^\d{1,2}$/)==-1||day<1||day>31){alert(dictionary.ageGate.errorDayOutOfBounds[actualLocale]);return false;}
else if(day<1||day>(32-new Date(year,(month-1),32).getDate())){alert(dictionary.ageGate.errorDayOutOfBoundsForMonth[actualLocale]);return false;}
else if(DOB_year.search(/^\d\d\d\d$/)==-1){alert(dictionary.ageGate.errorYearOutOfBounds[actualLocale]);return false;}
else{var minDate=new Date();minDate.setFullYear(minDate.getFullYear()-minAge);var selectedDate=new Date(year,month-1,day);if(selectedDate.getTime()>minDate.getTime()){$(".age-gate-instructions",$container).html(dictionary.ageGate.underAgeMessage[actualLocale]);$(".age-gate-selector",$container).hide();setCookie('ofAge','0');}
else{setCookie('ofAge','1');$(".age-gate").hide();$('.video-wrap').show();}}
return false;}
$(document).ready(function(){var $container=$('.scroll-container');var $content=$container.scrollify({scrollHandleMinHeight:10}).find('.scroll-content:first');$content.css('height',(($content.height()+1)+'px'));$container.find('.scroll-bar-track').append('<span class="hk-bg"></span>');});;(function($,window){$(document).ready(function(){$('#mod-menu-header').appendTo('#header-menu-custom');$('#mod-menu-header').removeClass('mod');$('#mod-menu-language').appendTo('#header-menu-custom');$('#mod-menu-language').removeClass('mod');$('#mod-menu-language .menu').removeClass('menu');var $current=$('#mod-menu-language .current-country'),$opener=$current.find('> .opener'),$flag=$current.find('> .flag');$opener.data('default',$opener.text());$flag.data('default',getCountry($flag));$('ul.countries > li > a').live('mouseenter',function(){$flag.removeClass($flag.data('default')).addClass(getCountry($(this).find('> .flag')));$opener.text($(this).find('> .label').text());}).live('mouseleave',function(){$flag.attr('class','flag '+$flag.data('default'));$opener.text($opener.data('default'));});function getCountry($elm){var className=$elm.attr('class');if(className){return $.trim(className.replace('flag',''));}
return'';}});})(jQuery,this);;(function($,window,undefined){$(window).load(function()
{var $carousel=$('#mod-editorial-pod > .mod-content > .carousel');var $firstImage=$carousel.find('li img').first();if($firstImage.width()<$carousel.width()){$carousel.css('width',$firstImage.width());}
$carousel.carousel({step:1,visible:1,loop:true,effect:'fade',pagination:true,autoSlide:true});});})(jQuery,this);;(function($,window,undefined){$(document).ready(function()
{var $carousel=$('#carousel-preorder');var visibleItemsCount=3;var containerWidth=$carousel.width();$carousel.find('> ul > li').css('width',Math.ceil(containerWidth/visibleItemsCount));$carousel.carousel({step:1,visible:visibleItemsCount});});})(jQuery,this);(function($,window,undefined){$('#mod-game-info .mod-content').prepend($('#mod-game-info .mod-header h3'));})(jQuery,this);;(function($,window,undefined){$(document).ready(function()
{var $ticker=$('#carousel-review-ticker');$ticker.find('li blockquote').css('width',$ticker.width());$ticker.carousel({step:1,visible:1,loop:true,effect:'fade',control:false,autoSlide:true,autoSlideInterval:8000});});})(jQuery,this);;(function($,window,undefined){$('#tabs-media-listing').tabs({cache:true,spinner:''});})(jQuery,this);;(function($,window,undefined){$(window).load(function()
{$('#mod-newsletter .mod-header').wrapInner('<div id="header-wrap" />');$('#mod-newsletter .mod-content').prepend($('#header-wrap'));$('#mod-newsletter .mod-content h3').unwrap();$('#mod-newsletter .mod-content .email .field-2').buttonset();var $select,$menu,h;$select=$('#mod-newsletter .mod-content .birthday .field-1 select');if($select.length===1)
{$select.selectmenu({width:70,menuWidth:88,maxHeight:100});$menu=$('#newsletterMonth-menu').show();h=$menu[0].scrollHeight;$('<span class="hk-bg"></span>').appendTo($menu).height(h);}
$select=$('#mod-newsletter .mod-content .birthday .field-2 select');if($select.length===1)
{$select.selectmenu({width:40,menuWidth:58,maxHeight:100});$menu=$('#newsletterDay-menu').show();h=$menu[0].scrollHeight;$('<span class="hk-bg"></span>').appendTo($menu).height(h);}
$select=$('#mod-newsletter .mod-content .birthday .field-3 select');if($select.length===1)
{$select.selectmenu({width:50,menuWidth:68,maxHeight:100});$menu=$('#newsletterYear-menu').show();h=$menu[0].scrollHeight;$('<span class="hk-bg"></span>').appendTo($menu).height(h);}});$('#formNewsletter').validation({success:function(evt,containerElm)
{var $containerElm=$(containerElm);var email=$('#newsletterEmail').val();var month=$('#newsletterMonth').val();var day=$('#newsletterDay').val();var year=$('#newsletterYear').val();var optIn=$('#newsletterSendExtra').attr('checked');$.ajax({type:"POST",url:EA.newsletter.subscribeUrl,data:"newsletterEmail={0}&newsletterMonth={1}&newsletterDay={2}&newsletterYear={3}&newsletterSendExtra={4}".replace("{0}",email).replace("{1}",month).replace("{2}",day).replace("{3}",year).replace("{4}",optIn),success:function(msg){var $msgContainer=$('#mod-newsletter .mod-content .message');if(msg=='SUCCESS'){$('#formNewsletter').addClass('signup-success');$msgContainer.find('.required-message').hide();$msgContainer.find('.success-message').html(EA.newsletter.thankYou);$msgContainer.find('.error-message').html('');}else{$('#formNewsletter').addClass('signup-error');$msgContainer.find('.required-message').hide();$msgContainer.find('.success-message').html('');$msgContainer.find('.error-message').html(msg);}},error:function(msg){$('#formNewsletter').addClass('signup-error');var $msgContainer=$('#mod-newsletter .mod-header .message');$msgContainer.find('.required-message').hide();$msgContainer.find('.success-message').html('');$msgContainer.find('.error-message').html(EA.newsletter.error);}});},error:function($elms,message)
{$('#mod-newsletter .mod-content .message .error-message').html(message);$elms.each(function(idx)
{$(this).parents('.field:first').addClass('field-error');});},required:function($elms)
{$('#mod-newsletter .mod-content .message .required-message').show();$elms.each(function(idx)
...
{return false;}
$elm.addClass('disabled');$elm.data('group').$containerElm.find('.field-error').removeClass('field-error');var $msgContainer=$('#mod-newsletter .mod-content .message');$msgContainer.find('.required-message').hide();$msgContainer.find('.error-message').html('');return true;},after:function($elm)
{$elm.removeClass('disabled');}}});})(jQuery,this);function populate_latest_news(data){var items=[];$.each(data.responseData.feed.entries,function(key,val){items.push('<li><div class="news-body"><a href="'+val.link+'">'+val.contentSnippet.replace(/(\\u0026nbsp;|\\n)*/g,'').replace(/(&nbsp;)+/g,'')+'</a></div></li>');});$('#mod-latest-news .mod-content').html('<ul>'+items.join('')+'</ul>');$('#mod-latest-news .mod-content ul').resetListClasses();}
(function($,window,undefined){$(document).ready(function(){if(EA.externalBlog&&EA.externalBlog.src)
$(document.body).append('<script type="text/javascript" src="https://ajax.googleapis.com/ajax/services/feed/load?v=1.0&q='+EA.externalBlog.src+'&callback=populate_latest_news" />');});})(jQuery,this);;(function($,window){if(EA){EA.baseDropdown=true;}})(jQuery,this);;(function($,window,undefined){var thisUrl=encodeURIComponent('http://www.ea.com'+location.pathname);$('#mod-social-networks .social-buttons').before('<span class="label">'+shareThisCopy+':</span>');$('#mod-social-networks .twitter').append('<a href="http://twitter.com/share?original_referer='+thisUrl+'&source=tweetbutton&text='+encodeURIComponent($("#mod-media-detail .mod-header h3").text())+'%20-%20EA&url='+thisUrl+'"><img src="'+EA.staticPath+EA.skinPath+'img/logo_twitter.png?ver='+EA.staticVersion+'" /></a>');$('#mod-social-networks .fb').append('<a href="http://www.facebook.com/sharer.php?u='+thisUrl+'&t='+encodeURIComponent($("#mod-media-detail .mod-header h3").text())+'%20-%20EA&src=sp"><img src="'+EA.staticPath+EA.skinPath+'img/logo_facebook.png?ver='+EA.staticVersion+'" /></a>');})(jQuery,this);;(function($,window,undefined){var $likebox=$('#mod-facebook-fans .mod-content iframe');if($likebox.length>0){var width=$likebox.parent().width();if($likebox.width()!=width){$likebox[0].src=$likebox[0].src.replace(/width=[0-9]+/,'width='+width);$likebox.css('width',width);}}})(jQuery,this);