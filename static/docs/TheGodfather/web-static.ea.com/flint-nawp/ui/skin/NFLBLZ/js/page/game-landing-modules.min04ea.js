...
{return;}});}});})(jQuery,this);(function($,window,undefined){if(EA.mobile&&EA.mobile.agents){for(i in EA.mobile.agents){var regex=new RegExp(EA.mobile.agents[i],"i");if(navigator.userAgent.match(regex)){$('#mod-mobile-redirect').show();break;}}}})(jQuery,this);;(function($,window,undefined){$('#mod-logo > .mod-content').html('<a href="http://www.easports.com" title="EA SPORTS"><span>EA SPORTS</span></a>');$('#mod-titles > .mod-content').html('<h1><a href="/nfl-blitz" title="NFL Blitz"><span>NFL Blitz</span></a></h1>');var logos='<div id="logos" class="row"><img alt="EA" src="'+EA.staticPath+EA.skinPath+'img/logo-footer.png?ver='+EA.staticVersion+'"/><img alt="NFL" src="'+EA.staticPath+EA.skinPath+'img/nflshield-footer-logo.png?ver='+EA.staticVersion+'"/><img alt="NFLP" src="'+EA.staticPath+EA.skinPath+'img/nflpa-footer-logo.png?ver='+EA.staticVersion+'"/></div>';$('#mod-footer .mod-header').prepend(logos);})(jQuery,this);;(function($,window,undefined){$(document).ready(function()
