...
{$carousel.carousel({step:1,visible:1,loop:true,effect:'fade',pagination:true,autoSlide:true});}});})(jQuery,this);;(function($,window,undefined){$('#tabs-media-listing').tabs({cache:true,spinner:''});$(window).load(function(evt)
{$('#mod-media-recently .scroll-container').scrollify({scrollHandleMinHeight:10});});})(jQuery,this);(function($,window,undefined){})(jQuery,this);