...
{return;}});}});})(jQuery,this);(function($,window,undefined){if(EA.mobile&&EA.mobile.agents){for(i in EA.mobile.agents){var regex=new RegExp(EA.mobile.agents[i],"i");if(navigator.userAgent.match(regex)){$('#mod-mobile-redirect').show();break;}}}})(jQuery,this);;(function($,window,undefined){$('#mod-logo > .mod-content').html('<a href="http://www.easports.com" title="EA SPORTS"><span>EA SPORTS</span></a>');$('#mod-titles > .mod-content').html('<h1><a href="/nba-jam-on-fire" title="NBA JAM on Fire Edition"><span>NBA JAM on Fire Edition</span></a></h1>');var div_nba=$('<div></div>').addClass('nba-logo');var img_nba=$('<img />').attr('src',EA.staticPath+EA.skinPath+'img/logo-nbacom.png').attr('width',176).attr('height',36).attr('alt','NBA');var lnk_nba=$('<a></a>').attr('href','http://www.nba.com/').attr('target','_blank');$('#mod-footer #legal').append($('<br/>')).append($('<span></span>').text('The NBA identifications are intellectual property of NBA Properties, Inc. All Rights Reserved. '+(new Date).getFullYear()+' NBA Properties, Inc.')).append(div_nba.append(lnk_nba.append(img_nba)));})(jQuery,this);;(function($,window,undefined){$(document).ready(function()
{var $carousel=$('#mod-editorial-pod > .mod-content > .carousel');if($carousel.find('> ul > li').length>1)
...
{var $carousel=$('#carousel-preorder');var visibleItemsCount=3;var containerWidth=$carousel.width();$carousel.find('> ul > li').css('width',Math.ceil(containerWidth/visibleItemsCount));$carousel.carousel({step:1,visible:visibleItemsCount});});})(jQuery,this);(function($,window,undefined){var title=$.trim($('#mod-titles h2').attr('title'));if(title.length>0)
{$('#mod-game-info .mod-header h3 span').html(title);}})(jQuery,this);;(function($,window,undefined){$(document).ready(function()
{var $ticker=$('#carousel-review-ticker');$ticker.find('li blockquote').css('width',$ticker.width());$ticker.carousel({step:1,visible:1,loop:true,effect:'fade',control:false,autoSlide:true,autoSlideInterval:8000});});})(jQuery,this);;(function($,window,undefined){$('#tabs-media-listing').tabs({cache:true,spinner:''});$(window).load(function(evt)
{$('#mod-media-recently .scroll-container').scrollify({scrollHandleMinHeight:10});});})(jQuery,this);;(function($,window,undefined){$(window).load(function()
...
$(document.body).append('<script type="text/javascript" src="https://ajax.googleapis.com/ajax/services/feed/load?v=1.0&q='+EA.externalBlog.src+'&callback=populate_latest_news" />');});})(jQuery,this);;(function($,window){if(EA){EA.baseDropdown=true;}})(jQuery,this);;(function($,window,undefined){var $likebox=$('#mod-facebook-fans .mod-content iframe');if($likebox.length>0){var width=$likebox.parent().width();if($likebox.width()!=width){$likebox[0].src=$likebox[0].src.replace(/width=[0-9]+/,'width='+width);$likebox.css('width',width);}}})(jQuery,this);;(function($,window,undefined){})(jQuery,this);